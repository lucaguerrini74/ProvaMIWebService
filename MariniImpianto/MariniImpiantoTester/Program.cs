    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (true)
            {
                ...
                MariniImpiantoTree.InitializeFromXmlFile(@"..\..\..\XMLFiles\impianto.xml");
                ...
                using (TextWriter writer = new StreamWriter(@"..\..\..\XMLFiles\impiantoMariniSerializzato.xml"))
                {
                ...
                using (var sr = new StreamReader(@"..\..\..\XMLFiles\impiantoMariniSerializzato.xml "))
                {
